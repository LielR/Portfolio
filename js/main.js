...
function renderProjs() {
    ...
    var strHTML = gProjs.map((project) =>
    `
    <div class="col-md-4 col-sm-6 portfolio-item">
        ...
        <img class="img-fluid" src="img/portfolio/${project.id.toLowercase()}.png" alt="">
    </a>
...
function renderModal(id) {
    ...
    <img class="img-fluid d-block mx-auto" src="img/portfolio/${project.id.toLowercase()}.png" alt="">
    <p>${project.desc}</p>
    <ul class="list-inline">
      <li>Date: ${formatDate(project.createdAt)}</li>
    </ul>
    <a href="${project.url}" target="_blank"><button class="btn btn-danger" type="button">Check it out!</button></a>
    `
